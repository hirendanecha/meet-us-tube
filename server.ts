...
export function app(): express.Express {
  ...
  const distFolder = join(process.cwd(), 'dist/meetus-tube/browser');
  ...
  const template = fs
    .readFileSync(
      path.join(join(process.cwd(), 'dist/meetus-tube/browser'), 'index.html')
    )
    .toString();
    ...
    res.render(
      ...
      async (err, html) => {
        ...
        var seo: any = {
          ...
          image:
            'https://meetus.tube/assets/images/banner/banner.jpg',
          site: 'https://meetus.tube/',
          url: 'https://meetus.tube' + params,
          keywords: 'MeetUs.tube, MeetUs',
        };
        if (
          ...
          const talent = {
            ...
            image: post?.thumbfilename || post?.metaimage || post?.imageUrl || 'https://meetus.tube/assets/images/banner/banner.jpg',
          };
          seo.title = talent.name;
          seo.description = strip_html_tags(talent.description);
          seo.image = talent.image;
          ...
          const talent = {
            name: `MeetUs.tube Research ${group?.PageTitle}`,
